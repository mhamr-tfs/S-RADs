...
import {
        exportFilteredReservationsToCsv,
        exportFilteredReservationsToExcel
} from "./export.js";
...
async function loadReservationPhotos(
        reservationId
) {
        const gallery =
...
async function uploadReservationPhoto(
        event
) {
...
export function attachFilterListeners() {
        ...
        if (exportExcelButton) {
                exportExcelButton.addEventListener(
                        ...
                        async () => {
                                try {
                                        await exportFilteredReservationsToExcel();
                                } catch (error) {
                                        console.error(
                                                "Excel export failed:",
                                                error
